...
deployment_id=EnvironmentFetcher.get_variable(EnvironmentVariables.DEPLOYMENT_NAME)
...
speech_config.speech_synthesis_voice_name= 'en-US-ShimmerMultilingualNeuralHD' #'en-US-JennyMultilingualNeural'
...
def ask_openai(prompt):
    ...
    response = client.chat.completions.create(model=deployment_id, max_tokens=500, stream=True, messages=[
        {"role": "system", "content": "You are a helpful assistant. I am here to assist you with your questions. You reply with an answer in less than 100 words"},
